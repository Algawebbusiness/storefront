...
> - **Fáze F (F1–F8): 🚧 IN PROGRESS** — full shopping flow + paired-tool PII isolation + three-layer fallback (feature flag / handshake timeout / ErrorBoundary):
...
>   - **F9 čeká** — docs/tests/telemetry; phase F closure.
